    ...
    return(
        <div>
            ...
            <div className="pag-logo-1-1-a">
                  ...
                  <div><b>Prof. Mukesh Pandey </b></div>
        ...
        <tbody>
          ...
          <tr>
            <td>4.</td>
            <td>Dr. Krishna Kanth Pulicherla<br></br>
            TDT Division, DST, Govt. of India
            </td>
            <td>DST Representative </td>
          </tr>
          <tr>
            <td>5.</td>
            <td>Dr. A. Abhyankar<br></br>
            TEC Coordinator, Pune University </td>
            <td>DST Nominee</td>
          </tr>
          <tr>
            <td>6.</td>
            <td>Dr. Deepak Chitkara<br></br>
            TEC Coordinator, BITS, Pilani </td>
            <td>DST Nominee</td>
          </tr>
          ...
          <tr>
            <td>9.</td>
            <td>Dr. Ved Prakash Dwivedi <br></br>
            Shree Baidyanath Ayurved Bhavan, Pvt. Ltd.</td>
            <td>Industry Member
...
(BHEL, Jhansi)
          ...
          <tr>
            <td>12.</td>
            <td>Dr. K. Rajarajan<br></br>
            Senior Scientist, Division of Tree Improvement Research, CAFRI Jhansi</td>
            <td>Member of the partner Institute (CAFRI, Jhansi)</td>
          </tr>
          <tr>
            <td>13.</td>
            <td>Dr. Prabhakant Pathak<br></br> 
            Principal Scientist, Agricultural Structure & Process Engineering, IGFRI, Jhansi</td>
            <td>Member of the partner Institute (IGFRI, Jhansi)</td>
          </tr>
          <tr>
            <td>14.</td>
            <td>Prof. Sanjay Kumar Gupta 
            <br></br>Dept. of Computer Science & Engineering, BIET, Jhansi</td>
            <td>Member of the partner Institute (BIET, Jhansi) </td>
          </tr>
          <tr>
            <td>15.</td>
            <td>Dr. Vijay Kumar
            <br></br>Research Officer, CRAS-CARI, Jhansi</td>
            <td>Member of the partner Institute <br></br>(Central Ayurved Research Institute, Jhansi)</td>
          </tr>
          <tr>
            <td>16.</td>
            <td>Prof. Sunil Kabia<br></br>
            Professor of Tourism & Hotel Management<br></br>
            Director, Incubation Centre
