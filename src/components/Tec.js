  ...
  return (
    <>
      ...
      <div className="Tec-container">
        ...
        <div className="row">
          <div className="part-1">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/Anna_University_Logo.png"></img>
          ...
          <div className="part-2">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/Punjab_University_tec.jpg"></img>
        ...
        <div className="row">
          <div className="part-1">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/sppu_tec.jpg"></img>
          ...
          <div className="part-3">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/University_of_Hyderabad_tec.png"></img>
        ...
        <div className="row">
          <div className="part-1">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/Tezpur_University_tec.png"></img>
        ...
        <div className="row">
          ...
          <div className="part-2">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/GITAM.jpg"></img>
        ...
        <div className="row">
          <div className="part-1">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/Pandit_Deendayal_Energy_University_logo.png"></img>
          ...
          <div className="part-3">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/Dr._Hari_Singh_Gour_University_Logo.png"></img>
        ...
        <div className="row">
          <div className="part-1">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/Guru-Ghasidas-Central-University-Chhattisgarh.png"></img>
          ...
          <div className="part-2">
            <img src="https://www.bits-pilani.ac.in/wp-content/uploads/Rajiv_Gandhi_University_Logo.jpg"></img>
