       ...
       <div>
        ...
        <div className="partners-main-container">
          ...
          <div className="partners">
                  ...
                  <p> RLBCAU is dedicated to agricultural education, research, and extension services. It offers undergraduate, postgraduate, and doctoral programs in various fields related to agriculture and allied sciences, including horticulture, animal science, agribusiness management, etc. The university's primary goal is to promote agricultural research and education to enhance agricultural productivity and the livelihoods of farmers in the region.</p>
                    </div>
                    </div>
                </div>
                <div className="partners">
                    ...
                    {/* <hr style={{width:"60%",border:"2px solid black",marginTop:"2rem"}}></hr> */}
                    <div className="partner-content">
                    <p> The primary focus of IGFRI is on research related to grasslands, forage crops, and fodder production. The institute conducts scientific research to develop improved varieties of grasses and forage crops that are suitable for various agro-climatic regions in India. This research aims to enhance livestock productivity by ensuring a consistent and nutritious feed supply. IGFRI also works on sustainable land management practices, soil fertility improvement, and conservation of grassland ecosystems. Additionally, it provides technical guidance, training, and extension services to farmers and stakeholders in the field of fodder production and management.</p>
                    </div>
                    </div>
                </div>
                <div className="partners">
                    ...
                    {/* <hr style={{width:"60%",border:"2px solid black",marginTop:"2rem"}}></hr> */}
                    <div className="partner-content">
                        <p>The Bundelkhand Institute of Engineering & Technology (BIET) is an engineering and technology institute located in Jhansi, Uttar Pradesh, India. It is one of the prominent technical institutions in the Bundelkhand region</p>
                    <p>BIET is affiliated with Dr. A.P.J. Abdul Kalam Technical University (formerly known as Uttar Pradesh Technical University) and follows the curriculum and standards set by the university and the All India Council for Technical Education (AICTE). The institute also engages in research activities and collaborates with industries and research organizations to promote innovation and technological advancement.</p>
                    </div>
                    </div>
                </div>
